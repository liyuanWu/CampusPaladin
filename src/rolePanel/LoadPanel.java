...
public class LoadPanel extends JPanel implements Runnable, Serializable {
	private int witchPanel = 2;
	// 任务面板
	private Image role;
	private Image strip;
	...
	public LoadPanel(int[] points, String fileName, String[] saveString)
			throws IOException {
