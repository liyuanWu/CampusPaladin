...
public class interludePanel extends JPanel implements Runnable{
	...
	public int frame;
	public inter.totalGameInter controler;
	...
	public interludePanel(int i,inter.totalGameInter p) throws FileNotFoundException, URISyntaxException {
		super();
